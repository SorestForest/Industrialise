    ...
    protected boolean moveItemStackTo(ItemStack p_75135_1_, int p_75135_2_, int p_75135_3_, boolean p_75135_4_) {
        ...
        if (p_75135_1_.isStackable()) {
            while(!p_75135_1_.isEmpty()) {
                ...
                if (!itemstack.isEmpty() && consideredTheSameItem(p_75135_1_, itemstack) && handler.isItemValid(i,p_75135_1_)) {
        ...
        if (!p_75135_1_.isEmpty()) {
            ...
            while(true) {
                ...
                if (itemstack1.isEmpty() && slot1.mayPlace(p_75135_1_) && handler.isItemValid(i,p_75135_1_)) {
